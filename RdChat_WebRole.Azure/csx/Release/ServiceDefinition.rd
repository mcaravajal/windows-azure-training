...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="RdChat_WebRole.Azure" generation="1" functional="0" release="0" Id="716b92ad-d0a8-44aa-9dbe-10b83c3627da" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="RdChat_WebRole.AzureGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="RdChat_WebRole" generation="1" functional="0" release="0" software="C:\windows-azure-training\RdChat_WebRole.Azure\csx\Release\roles\RdChat_WebRole" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="1792" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
        ...
        <groupHascomponents>
          <role name="WorkerRole1" generation="1" functional="0" release="0" software="C:\windows-azure-training\RdChat_WebRole.Azure\csx\Release\roles\WorkerRole1" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="1792" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="096f9c73-e8b2-4743-a4fd-5334706a191f" ref="Microsoft.RedDog.Contract\ServiceContract\RdChat_WebRole.AzureContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="b91d9039-f03f-447c-a883-e07294482b41" ref="Microsoft.RedDog.Contract\Interface\RdChat_WebRole:HttpIn@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/RdChat_WebRole.Azure/RdChat_WebRole.AzureGroup/RdChat_WebRole:HttpIn" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="44e2e1bf-035b-4332-be5e-0b06c37e478b" ref="Microsoft.RedDog.Contract\Interface\WorkerRole1:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/RdChat_WebRole.Azure/RdChat_WebRole.AzureGroup/WorkerRole1:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput" />
          </inPort>
        </interfaceReference>
